...
export default function App() {
  ...
  return (
      <div style={containerStyle}>
          <div>
              <h1 style={headerStyle}>Departments</h1>
              <Button onClick={() => navigateTo('/adddepartment')} style={buttonStyle} variant="contained"
                      color="primary">
                  Add Department
              </Button>
              <Button onClick={() => navigateTo('/showdepartment')} style={{...buttonStyle, width: 'auto'}} variant="contained"
                      color="primary">
                  Show All Departments
              </Button>
              <Button onClick={() => navigateTo('/editdepartment')} style={buttonStyle} variant="contained"
                      color="primary">
                  Edit Department
              </Button>
              <Button onClick={() => navigateTo('/deletedepartment')} style={buttonStyle} variant="contained"
                      color="secondary">
                  Delete Department
              </Button>
          </div>
          ...
          <div>
              <h1 style={headerStyle}>Employees</h1>
              <Button onClick={() => navigateTo('/addemployee')} style={buttonStyle} variant="contained"
                      color="primary">
                  Add Employee
              </Button>
              <Button onClick={() => navigateTo('/showemployee')} style={buttonStyle} variant="contained"
                      color="primary">
                  Show All Employees
              </Button>
              <Button onClick={() => navigateTo('/editemployee')} style={buttonStyle} variant="contained"
                      color="primary">
                  Edit Employee
              </Button>
              <Button onClick={() => navigateTo('/deleteemployee')} style={buttonStyle} variant="contained"
                      color="secondary">
                  Delete Employee
              </Button>
          </div>
